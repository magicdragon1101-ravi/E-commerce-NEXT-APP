  ...
  return (
    <div className="text-white w-full h-32  flex justify-around items-center bg-slate-900 rounded-xl my-4">
      ...
      <div className="w-40 h-full flex items-center justify-center ">
        <button
          onClick={handleAdd}
          className="text-2xl  text-center font-semibold  outline-none hover:scale-125 transition duration-500 w-10 h-10  flex items-center justify-center "
        >
          +
        </button>
        <p className=" text-gray-100 scale-110 font-semibold w-10 h-10 flex items-center justify-center text-2xl">
          {Curquantity}
        </p>
        <button
