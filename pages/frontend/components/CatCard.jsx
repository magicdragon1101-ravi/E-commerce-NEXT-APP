...
export default function CatCard({ item }) {
  ...
  return (
    <Link
      href={`viewProductByCategories/${item._id}`}
      className={`shadow-xl gap-4 mx-6 my-3 w-96 h-52 bg-green-600 flex items-center justify-center  rounded-2xl relative  transition-all hover:scale-110  duration-700 cursor-pointer`}
