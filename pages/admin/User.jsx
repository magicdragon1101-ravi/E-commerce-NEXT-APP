                    ...
                    {data?.map((user) => {
                      return (
                        <tr className="border-b " key={user._id}>
                          ...
                          <td className="text-sm text-white font-light px-6 py-4 whitespace-nowrap">{user.name}</td>
                          <td className="text-sm text-white font-light px-6 py-4 whitespace-nowrap">{user.email}</td>
                        </tr>
                      );
                    })}
                  </tbody>
