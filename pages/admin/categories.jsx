                    ...
                    {finalData?.map((category) => {
                      return (
                        <tr className="border-b " key={category._id}>
                          ...
                          <td className="text-sm text-white font-light px-6 py-4 whitespace-nowrap">{category.name}</td>
                          ...
                          <td>
                            <Link
                              ...
                              class="bg-orange-500 mx-2 hover:bg-orange-900 text-white font-bold py-2 px-4 rounded-full"
                            >
                              Update
                            </Link>
                            <button
                              onClick={() => handleDelete(category._id)}
                              class="bg-red-500 mx-2 hover:bg-red-900 text-white font-bold py-2 px-4 rounded-full"
                            >
                              Delete
                            </button>
                          </td>
